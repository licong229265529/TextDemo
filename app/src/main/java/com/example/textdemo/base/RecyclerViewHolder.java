...
import com.example.textdemo.utils.Utils;
...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     * 设置TextView的值
     */
    public RecyclerViewHolder setTextStrike(int viewId, String text) {
        TextView tv = getView(viewId);
        tv.setText(text);
    ...
    public RecyclerViewHolder setImageView(int viewId, int imageId) {
     ...
     * @param baseAdapter
     */
    public RecyclerViewHolder setGridViewAdapter(int viewId, BaseAdapter baseAdapter) {
